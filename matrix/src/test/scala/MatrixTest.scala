  ...
  test("can extract column") {
    Matrix(
      "1 2 3\n"
        + "4 5 6\n"
        + "7 8 9"
    ).column(2) should be(Vector(3, 6, 9))
  }
  ...
  test("can extract column from non-square matrix") {
    Matrix(
      "1 2 3\n"
        ...
        + "7 8 9\n"
        + "8 7 6"
    ).column(2) should be(Vector(3, 6, 9, 6))
  }
  ...
  test("extract column where numbers have different widths") {
    Matrix(
      "89 1903 3\n"
        + "18 3 1\n"
        + "9 4 800"
    ).column(1) should be(Vector(1903, 3, 4))
  }
}
